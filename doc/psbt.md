# PSBT Howto for Quantum Coin Core

Since Quantum Coin Core 0.17, an RPC interface exists for Partially Signed Quantum Coin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/qtc/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Quantum Coin transactions that are not fully signed
...
#### Multisig with multiple Quantum Coin Core instances
