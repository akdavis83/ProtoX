...
Assumeutxo is a feature that allows fast bootstrapping of a validating qtcd
instance.
...
```
$ qtc-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ qtc-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
