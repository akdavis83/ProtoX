...
This guide describes how to build qtcd, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run qtcd or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/qtc/qtc/blob/master/doc/descriptors.md).
...
There are many ways to configure Quantum Coin Core. Here is an example that
