...
This document provides guidelines for internationalization of the Quantum Coin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Quantum Coin network</source>
        <translation>
            <numerusform>%n active connection to Quantum Coin network</numerusform>
            <numerusform>%n active connections to Quantum Coin network</numerusform>
        </translation>
    </message>
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `qtc_en.ts` remains unchanged.
