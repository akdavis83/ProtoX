...
Quantum Coin Core version 0.19.1 is now available from:

  <https://qtccore.org/bin/qtc-core-0.19.1/>
...
From Quantum Coin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Quantum Coin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Quantum Coin Core does not yet change appearance when
...
- #17488 fix "qtcd already running" warnings on macOS (fanquake)
