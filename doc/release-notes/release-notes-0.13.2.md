Quantum Coin Core version 0.13.2 is now available from:

  <https://qtc.org/bin/qtc-core-0.13.2/>
...
- #8908 `4a974b2` Update qtc-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow qtc-tx to create v2 transactions (btcdrak)
