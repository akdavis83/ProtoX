Quantum Coin Core version 0.16.1 is now available from:

  <https://qtccore.org/bin/qtc-core-0.16.1/>
...
- #12843 `df38b13` Test starting qtcd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure qtcd processes are cleaned up when tests end (sdaftuar)
