Quantum Coin Core version 0.9.4 is now available from:

  https://qtc.org/bin/0.9.4/
...
this update is incompatible with the Quantum Coin system and could lead to consensus
forks.

Quantum Coin Core released binaries from https://qtc.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~qtc/+archive/ubuntu/qtc
- A third-party or self-compiled Quantum Coin Core

upgrade to Quantum Coin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
