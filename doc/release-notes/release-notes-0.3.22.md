Download URL: https://sourceforge.net/projects/qtc/files/Quantum Coin/qtc-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 QTC fee schedule (users still pay 0.01 QTC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #qtc00 - #qtc99
