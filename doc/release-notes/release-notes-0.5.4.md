Quantum Coin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/qtc/files/Quantum Coin/qtc-0.5.4/
...
http://gitorious.org/qtc/qtcd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Quantum Coin-Qt notifications under Growl 1.3.
Increase required age of Quantum Coin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQuantum Coin properly when installing Quantum Coin-Qt over it. (Windows)
