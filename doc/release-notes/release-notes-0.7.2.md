Quantum Coin version 0.7.2 is now available from:
  http://sourceforge.net/projects/qtc/files/Quantum Coin/qtc-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Quantum Coin-Qt to crash on Windows when exiting.
