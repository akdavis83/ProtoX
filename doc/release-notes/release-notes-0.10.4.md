Quantum Coin Core version 0.10.4 is now available from:

  <https://qtc.org/bin/qtc-core-0.10.4/>
...
- #6953 `43c2789` Split qtc-tx into its own package
- #6953 `dfe0d4d` Include qtc-tx binary on Debian/Ubuntu
