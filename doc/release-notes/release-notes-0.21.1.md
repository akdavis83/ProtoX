...
Quantum Coin Core version 0.21.1 is now available from:

  <https://qtccore.org/bin/qtc-core-0.21.1/>
...
fungibility of all qtcs. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Quantum Coin Core's wallet is
...
FAQ](https://qtccore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/qtc/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/qtc/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/qtc/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Quantum Coin](https://qtcmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-qtc)
  - [What do Schnorr Signatures Mean for Quantum Coin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-qtc)
...
- Development history overview
  - [Taproot](https://qtcops.org/en/topics/taproot/)
  - [Schnorr signatures](https://qtcops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://qtcops.org/en/topics/tapscript/)
  - [Soft fork activation](https://qtcops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://qtc.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/qtc/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/qtc/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to qtc.conf documentation (jonatack)
