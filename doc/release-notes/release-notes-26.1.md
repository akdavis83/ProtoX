...
Quantum Coin Core version 26.1 is now available from:

  <https://qtccore.org/bin/qtc-core-26.1/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Quantum Coin
