Quantum Coin Core version 0.9.2.1 is now available from:

  https://qtc.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 QTC to 0.01 QTC
