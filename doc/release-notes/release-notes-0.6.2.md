Quantum Coin version 0.6.2 is now available for download at:
http://sourceforge.net/projects/qtc/files/Quantum Coin/qtc-0.6.2/
...
Fixed https://github.com/qtc/qtc/issues/1065, a bug that
