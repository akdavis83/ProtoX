Quantum Coin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qtc/files/Quantum Coin/qtc-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Quantum Coin
...
New/changed settings (command-line or qtc.conf file)
--------------------------------------------------------
