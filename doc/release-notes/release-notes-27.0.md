Quantum Coin Core version 27.0 is now available from:

  <https://qtccore.org/bin/qtc-core-27.0/>
...
- libqtcconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libqtckernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Quantum Coin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Quantum Coin Core would
