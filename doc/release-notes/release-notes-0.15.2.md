Quantum Coin Core version *0.15.2* is now available from:

  <https://qtccore.org/bin/qtc-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in qtc-tx (TheBlueMatt)
