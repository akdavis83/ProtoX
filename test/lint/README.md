...
```sh
DOCKER_BUILDKIT=1 docker build -t qtc-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/qtc -it qtc-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/qtc-core/crc32c-subtree.git (branch qtc-fork)
* for `src/crypto/ctaes`: https://github.com/qtc-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/qtc-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/qtc-core/leveldb-subtree.git (branch qtc-fork)
* for `src/minisketch`: https://github.com/qtc-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/qtc-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/qtc-core/secp256k1.git
```
