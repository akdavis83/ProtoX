...
class TxnMallTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 QTC:
        ...
        # First: use raw transaction API to send 1240 QTC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 QTC coin each
        ...
        # Node0's balance should be starting balance, plus 50QTC for another
        ...
        # Node0's total balance should be starting balance, plus 100QTC for
