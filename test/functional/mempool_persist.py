...
By default, qtcd will dump mempool on shutdown and
...
class MempoolPersistTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent qtcd from writing mempool.dat to disk. Verify that `savemempool` fails")
