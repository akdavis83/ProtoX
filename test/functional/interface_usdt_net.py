...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/qtc/qtc/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(Quantum CoinTestFramework):
    ...
    def p2p_message_tracepoint_test(self):
        ...
        self.log.info("connect a P2P test node to our qtcd node")
    ...
    def inbound_conn_tracepoint_test(self):
        ...
        self.log.info("connect two P2P test nodes to our qtcd node")
        testnodes = list()
    ...
    def outbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_OUTBOUND_CONNECTIONS} P2P test nodes to our qtcd node")
        testnodes = list()
    ...
    def evicted_inbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {MAX_INBOUND_CONNECTIONS + EXPECTED_EVICTED_CONNECTIONS} P2P test nodes to our qtcd node and expect {EXPECTED_EVICTED_CONNECTIONS} evictions")
        testnodes = list()
    ...
    def misbehaving_conn_tracepoint_test(self):
        ...
        self.log.info("connect a misbehaving P2P test nodes to our qtcd node")
    ...
    def closed_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_CLOSED_CONNECTIONS} P2P test nodes to our qtcd node")
        testnodes = list()
