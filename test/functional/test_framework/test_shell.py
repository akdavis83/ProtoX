...
class TestShell:
    """Wrapper Class for Quantum CoinTestFramework.

    The TestShell class extends the Quantum CoinTestFramework
    ...
    class __TestShell(Quantum CoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by Quantum CoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # Quantum CoinTestFramework instances are supposed to be constructed with the path
