...
Verify that a qtcd node can use an external signer command.
...
class RPCSignerTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart qtcd with -signer=<cmd>',
