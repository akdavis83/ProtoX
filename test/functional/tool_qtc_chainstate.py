...
class Quantum CoinChainstateTest(Quantum CoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_qtc_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing qtc-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    Quantum CoinChainstateTest(__file__).main()
