#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Quantum Coin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting qtc with -h works as expected."""

from test_framework.test_framework import Quantum CoinTestFramework
from test_framework.util import assert_equal

class HelpTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qtc with -h for help text")
        ...
        self.log.info("Start qtc with -version for version information")
        ...
        self.log.info("Start qtcd with -fakearg to make sure it does not start")
