#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Quantum Coin Core developers
...
class TxDownloadTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new qtcd instances, as setting mocktimes has long-term effects on when
