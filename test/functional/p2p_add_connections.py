...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The qtcd node closes feeler connections as soon as a version
...
class P2PAddConnections(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        # qtcd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that qtcd sends its own version prior to processing
