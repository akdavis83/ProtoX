...
class WalletTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 QTC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 QTC with subtract fee from amount
        ...
        # Sendmany 10 QTC with subtract fee from amount
        ...
        # Sendmany 5 QTC to two addresses with subtracting fee from both addresses
