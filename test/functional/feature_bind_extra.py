...
"""
Test starting qtcd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that qtcd has bound on "::1" (for RPC) and "::" (for P2P).
