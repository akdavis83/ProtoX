...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/qtc/qtc/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(Quantum CoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/qtc/qtc/blob/master/doc/tracing.md#tracepoint-validationblock_connected
