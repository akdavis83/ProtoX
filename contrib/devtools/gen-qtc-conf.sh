...
BITCOIND=${BITCOIND:-$BINDIR/qtcd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/qtc.conf}
...
then
  ...
  echo -e "To safely generate a qtc.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example qtc.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-qtc-conf.sh.
##
...
# parse the output from qtcd --help
