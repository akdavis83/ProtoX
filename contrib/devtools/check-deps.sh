...
declare -A LIBS
LIBS[cli]="libqtc_cli.a"
LIBS[common]="libqtc_common.a"
LIBS[consensus]="libqtc_consensus.a"
LIBS[crypto]="libqtc_crypto.a"
LIBS[node]="libqtc_node.a"
LIBS[util]="libqtc_util.a"
LIBS[wallet]="libqtc_wallet.a"
...
# https://github.com/qtc/qtc/issues/10102
