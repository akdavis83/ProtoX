...
def check_ELF_FORTIFY(binary) -> bool:
    ...
    # qtc-util does not currently contain any fortified functions
    if 'Quantum Coin Core qtc-util utility version ' in binary.strings:
        return True
    # qtc wrapper does not currently contain any fortified functions
