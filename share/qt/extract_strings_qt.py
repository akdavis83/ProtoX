#!/usr/bin/env python3
# Copyright (c) 2012-2021 The Quantum Coin Core developers
...
#endif
""")
f.write('static const char UNUSED *qtc_strings[] = {\n')
f.write('QT_TRANSLATE_NOOP("qtc-core", "%s"),\n' % (os.getenv('COPYRIGHT_HOLDERS'),))
