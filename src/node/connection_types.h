...
#ifndef QTC_NODE_CONNECTION_TYPES_H
#define QTC_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/qtc-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Quantum Coin’s Peer-to-Peer Network")
...
#endif // QTC_NODE_CONNECTION_TYPES_H
