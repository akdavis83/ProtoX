...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox msgBoxConfirm(QMessageBox::Question,
                                  ...
                                  tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR QTC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
