...
#ifndef QTC_QT_OPTIONSMODEL_H
#define QTC_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Quantum Coin client.
...
public:
    ...
    Quantum CoinUnit getDisplayUnit() const { return m_display_qtc_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSQTControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    Quantum CoinUnit m_display_qtc_unit;
...
Q_SIGNALS:
    void displayUnitChanged(Quantum CoinUnit unit);
