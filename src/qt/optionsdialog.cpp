      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->qtcAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->qtcAtStartup);
    ...
    ui->qtcAtStartup->setToolTip(ui->qtcAtStartup->toolTip().arg(CLIENT_NAME));
    ui->qtcAtStartup->setText(ui->qtcAtStartup->text().arg(CLIENT_NAME));

    ui->openQuantum CoinConfButton->setToolTip(ui->openQuantum CoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new Quantum CoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->qtcAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSQTControls);
...
void OptionsDialog::on_openQuantum CoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openQuantum CoinConf())
