...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = Quantum CoinUnits::formatWithUnit(unit, amount, true, Quantum CoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    Quantum CoinUnit unit{Quantum CoinUnit::QTC};
...
{
    Quantum CoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(Quantum CoinUnits::formatWithPrivacy(unit, balances.balance, Quantum CoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(Quantum CoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, Quantum CoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(Quantum CoinUnits::formatWithPrivacy(unit, balances.immature_balance, Quantum CoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(Quantum CoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, Quantum CoinUnits::SeparatorStyle::ALWAYS, m_privacy));
