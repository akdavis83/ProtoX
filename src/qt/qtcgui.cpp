...
const std::string Quantum CoinGUI::DEFAULT_UIPLATFORM =
...
Quantum CoinGUI::Quantum CoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &Quantum CoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &Quantum CoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &Quantum CoinGUI::showModalOverlay);
...
Quantum CoinGUI::~Quantum CoinGUI()
{
...
void Quantum CoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quantum Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qtc: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &Quantum CoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &Quantum CoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &Quantum CoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quantum Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quantum Coin addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Quantum Coin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Quantum Coin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a qtc: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Quantum Coin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &Quantum CoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &Quantum CoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &Quantum CoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &Quantum CoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &Quantum CoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &Quantum CoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &Quantum CoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &Quantum CoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &Quantum CoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &Quantum CoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &Quantum CoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &Quantum CoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &Quantum CoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &Quantum CoinGUI::showDebugWindow);
}

void Quantum CoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void Quantum CoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &Quantum CoinGUI::setCurrentWalletBySelectorIndex);
...
void Quantum CoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &Quantum CoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &Quantum CoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &Quantum CoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &Quantum CoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void Quantum CoinGUI::enableHistoryAction(bool privacy)
{
...
void Quantum CoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &Quantum CoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &Quantum CoinGUI::removeWallet);
...
WalletController* Quantum CoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void Quantum CoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &Quantum CoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &Quantum CoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &Quantum CoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &Quantum CoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &Quantum CoinGUI::incomingTransaction);
    connect(this, &Quantum CoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void Quantum CoinGUI::removeWallet(WalletModel* walletModel)
{
...
void Quantum CoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void Quantum CoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void Quantum CoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void Quantum CoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void Quantum CoinGUI::createTrayIcon()
{
...
void Quantum CoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &Quantum CoinGUI::toggleHidden);
...
void Quantum CoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void Quantum CoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void Quantum CoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void Quantum CoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void Quantum CoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void Quantum CoinGUI::openClicked()
{
...
void Quantum CoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void Quantum CoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void Quantum CoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void Quantum CoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void Quantum CoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void Quantum CoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void Quantum CoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void Quantum CoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Quantum Coin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void Quantum CoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void Quantum CoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void Quantum CoinGUI::updateHeadersSyncProgressLabel()
{
...
void Quantum CoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void Quantum CoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &Quantum CoinGUI::quitRequested);
...
void Quantum CoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void Quantum CoinGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &Quantum CoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void Quantum CoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void Quantum CoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &Quantum CoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &Quantum CoinGUI::show);
                e->ignore();
            }
        }
    }
...
void Quantum CoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void Quantum CoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void Quantum CoinGUI::incomingTransaction(const QString& date, Quantum CoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(Quantum CoinUnits::formatWithUnit(unit, amount, true));
...
void Quantum CoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void Quantum CoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool Quantum CoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool Quantum CoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void Quantum CoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void Quantum CoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void Quantum CoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void Quantum CoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void Quantum CoinGUI::updateWindowTitle()
{
...
void Quantum CoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void Quantum CoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void Quantum CoinGUI::detectShutdown()
{
...
void Quantum CoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void Quantum CoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(Quantum CoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = Quantum CoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void Quantum CoinGUI::subscribeToCoreSignals()
{
...
void Quantum CoinGUI::unsubscribeFromCoreSignals()
{
...
bool Quantum CoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<Quantum CoinUnit> units = Quantum CoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const Quantum CoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, Quantum CoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const Quantum CoinUnit u : Quantum CoinUnits::availableUnits()) {
        menu->addAction(Quantum CoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(Quantum CoinUnit newUnits)
{
    setText(Quantum CoinUnits::longName(newUnits));
}
