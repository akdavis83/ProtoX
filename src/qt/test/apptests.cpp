...
//! Entry point for Quantum CoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &Quantum CoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for Quantum CoinGUI tests.
void AppTests::guiTests(Quantum CoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &Quantum CoinGUI::consoleShown, this, &AppTests::consoleTests);
