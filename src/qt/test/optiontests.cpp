...
{
    // Test regression https://github.com/qtc/qtc/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/qtc-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/qtc-core/gui/pull/568.
    // With fListen=false in ~/.config/Quantum Coin/Quantum Coin-Qt.conf and all else left as default,
    // qtc-qt should set both -listen and -listenonion to false and start successfully.
