...
/** Main Quantum Coin application object */
class QTCApplication: public QApplication
{
    Q_OBJECT
public:
    explicit Quantum CoinApplication();
    ~Quantum CoinApplication();
    ...
    /// Get window identifier of QMainWindow (Quantum CoinGUI)
...
Q_SIGNALS:
    ...
    void windowShown(QTCGUI* window);
