...
#ifndef QTC_QT_QTCGUI_H
#define QTC_QT_QTCGUI_H
...
/**
  QTC GUI main class. This class represents the main window of the Quantum Coin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QTCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Quantum CoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~Quantum CoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a qtc wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QTCUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Quantum Coin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QTCUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // QTC_QT_QTCGUI_H
