...
#ifndef QTC_QT_GUIUTIL_H
#define QTC_QT_GUIUTIL_H
...
/** Utility functions used by the Quantum Coin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qtc:" URI into recipient object, return true on successful parsing
