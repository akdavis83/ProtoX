...
#ifndef QTC_CLIENTVERSION_H
#define QTC_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by qtc-build-config.h or in any other way
#endif
