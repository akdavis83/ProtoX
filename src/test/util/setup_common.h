...
#ifndef QTC_TEST_UTIL_SETUP_COMMON_H
#define QTC_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/qtc/qtc/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // QTC_TEST_UTIL_SETUP_COMMON_H
