...
#ifndef QTC_TEST_SCRIPTNUM10_H
#define QTC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from QTC Core 0.10.0, for cross-comparison.
 */
public:
