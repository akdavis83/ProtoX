...
{
    BOOST_CHECK(TestSplitHost("www.qtccore.org", "www.qtccore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.qtccore.org]", "www.qtccore.org", 0));
    BOOST_CHECK(TestSplitHost("www.qtccore.org:80", "www.qtccore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.qtccore.org]:80", "www.qtccore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.qtccore.org:65536", "www.qtccore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.qtccore.org:0", "www.qtccore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.qtccore.org:", "www.qtccore.org:", 0, false));
}
