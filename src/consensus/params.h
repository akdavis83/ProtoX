...
#ifndef QTC_CONSENSUS_PARAMS_H
#define QTC_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Quantum Coin Script solution
