 ...
 * for both qtcd and qtc-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("QTC");


#include <qtc-build-info.h>
// The <qtc-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to QIP 14 spec (https://github.com/qtc/qips/blob/master/qip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure QTC Core copyright is not removed by accident
    if (copyright_devs.find("QTC Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The QTC Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/qtc/qtc>";
