// Copyright (c) 2019-2021 The QTC Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QTC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define QTC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // QTC_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
