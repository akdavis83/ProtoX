...
#include <algorithm>
#include <attributes.h> // Added for QTC Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for QTC Core
#include <util/string.h> // Added for QTC Core
...
// Added for QTC Core. Similar to std::runtime_format from C++26.
...
// Added for QTC Core. Wrapper for checking format strings at compile time.
