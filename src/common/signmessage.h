...
#ifndef QTC_COMMON_SIGNMESSAGE_H
#define QTC_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's qtc address, it must refer to a public key.
...
#endif // QTC_COMMON_SIGNMESSAGE_H
