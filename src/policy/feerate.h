...
#ifndef QTC_POLICY_FEERATE_H
#define QTC_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "QTC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    QTC_KVB,      //!< Use QTC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::QTC_KVB) const;
