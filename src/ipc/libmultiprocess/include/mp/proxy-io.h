...
extern thread_local ThreadContext g_thread_context; // NOLINT(qtc-nontrivial-threadlocal)
// Silence nonstandard qtc tidy error "Variable with non-trivial destructor
