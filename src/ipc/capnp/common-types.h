...
#ifndef QTC_IPC_CAPNP_COMMON_TYPES_H
#define QTC_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between qtc processes.
...
//! Functions to serialize / deserialize common qtc types.
namespace mp {
...
#endif // QTC_IPC_CAPNP_COMMON_TYPES_H
