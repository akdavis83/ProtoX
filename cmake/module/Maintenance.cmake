...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS qtc qtcd qtc-qt qtc-cli qtc-tx qtc-util qtc-wallet test_qtc bench_qtc)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET qtc AND TARGET qtc-qt AND TARGET qtcd AND TARGET qtc-cli AND TARGET qtc-tx AND TARGET qtc-wallet AND TARGET qtc-util AND TARGET test_qtc)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:qtc> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:qtc>
      ...
      COMMAND ${MAKENSIS_EXECUTABLE} -V2 ${PROJECT_BINARY_DIR}/qtc-win64-setup.nsi
      VERBATIM
    )
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET qtc-qt)
    set(macos_app "Quantum Coin-Qt.app")
    # Populate Contents subdirectory.
    configure_file(${PROJECT_SOURCE_DIR}/share/qt/Info.plist.in ${macos_app}/Contents/Info.plist NO_SOURCE_PERMISSIONS)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/PkgInfo CONTENT "APPL????")
    # Populate Contents/Resources subdirectory.
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/empty.lproj CONTENT "")
    configure_file(${PROJECT_SOURCE_DIR}/src/qt/res/icons/qtc.icns ${macos_app}/Contents/Resources/qtc.icns NO_SOURCE_PERMISSIONS COPYONLY)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/Base.lproj/InfoPlist.strings
      CONTENT "{ CFBundleDisplayName = \"@CLIENT_NAME@\"; CFBundleName = \"@CLIENT_NAME@\"; }"
    )

    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Quantum Coin-Qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component qtc-qt --prefix ${macos_app}/Contents/MacOS --strip
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:qtc-qt> ${macos_app}/Contents/MacOS/Quantum Coin-Qt
    ...
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Quantum Coin-Qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Quantum Coin-Qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Quantum Coin-Qt
      )
